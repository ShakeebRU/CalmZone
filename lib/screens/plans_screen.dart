...
class _PlansScreenState extends State<PlansScreen>
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => _showSubscriptionDialog(context, subscriptionProvider, isDark),
  ...
  Widget _buildWaterTab(bool isDark, NotificationProvider notificationProvider) {
  ...
  Widget _buildMealsTab(bool isDark, NotificationProvider notificationProvider) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Breakfast Section
          _buildMealSection('Breakfast', '🌅', MealPlansData.getBreakfastPlans(), isDark),
          const SizedBox(height: 24),
          // Lunch Section
          _buildMealSection('Lunch', '🍽️', MealPlansData.getLunchPlans(), isDark),
          const SizedBox(height: 24),
          // Dinner Section
          _buildMealSection('Dinner', '🌙', MealPlansData.getDinnerPlans(), isDark),
          const SizedBox(height: 24),
          // Snacks Section
          _buildMealSection('Snacks', '🍎', MealPlansData.getSnacksPlans(), isDark),
          const SizedBox(height: 24),
  ...
  Widget _buildMealSection(String title, String icon, List<MealCategory> categories, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
        ...
        ...categories.expand((category) => category.meals.map((meal) {
          return Padding(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.local_fire_department, size: 14, color: Constants.accentColor),
                      ...
                      const SizedBox(width: 12),
                      Icon(Icons.access_time, size: 14, color: Constants.getTextSecondaryColor(isDark)),
                      const SizedBox(width: 4),
                      Text(
            ...
            Icon(Icons.chevron_right, color: Constants.getTextSecondaryColor(isDark)),
          ],
        ),
      ),
    );
                  ...
                  children: [
                      ...
                      child: Image.network(
                        ...
                        errorBuilder: (context, error, stackTrace) {
                          return Container(
                            height: 200,
                            color: Constants.getInputBackgroundColor(isDark),
                            child: Icon(Icons.restaurant, size: 60, color: Constants.accentColor),
                          );
                        },
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          _buildNutritionItem('Calories', '${meal.nutrition.calories}', Icons.local_fire_department),
                          _buildNutritionItem('Protein', '${meal.nutrition.protein}g', Icons.fitness_center),
                          _buildNutritionItem('Carbs', '${meal.nutrition.carbs}g', Icons.grain),
                          _buildNutritionItem('Fat', '${meal.nutrition.fat}g', Icons.opacity),
                        ],
                      ),
                    ),
                    const SizedBox(height: 24),
                    ...
                    ...meal.ingredients.map((ingredient) {
                      return Padding(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.circle, size: 6, color: Constants.accentColor),
                            const SizedBox(width: 12),
                            Expanded(
                              child: Text(
                                ingredient,
      ...
      children: [
        ...
        Text(
          ...
          style: GoogleFonts.outfit(
            fontSize: 16,
            fontWeight: FontWeight.bold,
            color: Constants.getTextColor(Provider.of<ThemeProvider>(context, listen: false).isDarkMode),
          ),
        ),
        Text(
          label,
          style: GoogleFonts.outfit(
            fontSize: 10,
            color: Constants.getTextSecondaryColor(Provider.of<ThemeProvider>(context, listen: false).isDarkMode),
          ),
        ),
      ],
    );
  ...
  Widget _buildWorkoutTab(bool isDark, NotificationProvider notificationProvider) {
    final workouts = [
      {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildNotificationCard(
            ...
            (value) => notificationProvider.toggleNotification('workout', value),
            isDark,
            info: 'Time: ${notificationProvider.notificationTimes['workout']} (customizable in drawer)',
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Image.network(
              ...
              errorBuilder: (context, error, stackTrace) {
                return Container(
                  height: 150,
                  color: Constants.getInputBackgroundColor(isDark),
                  child: Icon(Icons.fitness_center, size: 60, color: Constants.accentColor),
                );
              },
            ),
          ),
          ...
          Row(
            children: [
              Icon(Icons.access_time, size: 16, color: Constants.getTextSecondaryColor(isDark)),
              const SizedBox(width: 4),
              Text(
  ...
  Widget _buildMeditationTab(bool isDark, NotificationProvider notificationProvider) {
    final meditations = [
      {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildNotificationCard(
            ...
            (value) => notificationProvider.toggleNotification('meditation', value),
            isDark,
            info: 'Time: ${notificationProvider.notificationTimes['meditation']} (customizable in drawer)',
          ),
        ],
      ),
    );
