...
class Constants {
  ...
  static Color darkBorderColor = const Color(0xFF374151);
  static Color darkInputBackgroundColor = const Color(0xFF2A2A2A);
  
  // Common Colors (work in both modes)
  static Color secondaryColor = const Color(0xFFfcb142);
  static Color secondaryColor2 = const Color.fromARGB(255, 255, 223, 174);
  static Color accentColor = const Color(0xFFfcb142);
